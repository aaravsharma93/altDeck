...
export default function LaunchpadForm() {
    ...
    return (
        <div className="launchpad___form___main">
            <Container component="main" maxWidth="xs">
                ...
                <div>
                    <Typography
                        ...
                        variant="h3"
                        my={3}
                        className="heading___launchpad__form"
                    >
                        Launchpad Application Form
                    </Typography>
                    <form className="launchpad___form" method="post">
                        <Grid container spacing={2}>
                            ...
                            <Grid item xs={12} mb={2}>
                                <TextField
                                    autoComplete="itemscollection"
                                    name="itemsInCollection"
                                    variant="standard"
                                    required
                                    fullWidth
                                    id="itemsInCollection"
                                    label="Amount Of Items In Collection"
                                />
                            </Grid>
                            <Grid item xs={12} mb={2}>
                                <TextField
                            ...
                            <Grid item xs={12} mb={2} style={{ display: "flex" }}>
                                <label className="checkbox__text__launchpad">
                                    {" "}
                            ...
                            <Grid item xs={12} mb={2} style={{ display: "flex" }}>
                                {" "}
                                <FormControlLabel
                                    className="checkbox___terms___launchpad"
                                    control={<Checkbox />}
